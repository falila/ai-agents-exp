...
MERCHANT_WALLET_ADDRESS = os.getenv("MERCHANT_WALLET_ADDRESS", MERCHANT_RECEIVING_ADDRESS)
MERCHANT_WALLET_SECRET = os.getenv("MERCHANT_WALLET_SECRET", "")

# Consumer wallet configuration
CONSUMER_WALLET_ADDRESS = os.getenv("CONSUMER_WALLET_ADDRESS", "")
CONSUMER_WALLET_SECRET = os.getenv("CONSUMER_WALLET_SECRET", "")
